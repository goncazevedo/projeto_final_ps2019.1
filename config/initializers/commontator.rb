...
Commontator.configure do |config|
  ...
  # Default: ->(user) { I18n.t('commontator.anonymous') ser) { I18n.t('commontator.anonymous') } (all users are anonymous)
  ...
  # The commontator_gravatar_image_tag helper takesng containing a HTML <img> tag pointing to the user's avatar image
