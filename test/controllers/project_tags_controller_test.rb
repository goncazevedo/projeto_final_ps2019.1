...
class ProjectTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_tag" do
    assert_difference('ProjectTag.count') do
      post project_tags_url, params: { project_tag: { project_id: @project_tag.project_id, tag_id: @project_tag.tag_id } }
    end
  ...
  test "should update project_tag" do
    patch project_tag_url(@project_tag), params: { project_tag: { project_id: @project_tag.project_id, tag_id: @project_tag.tag_id } }
